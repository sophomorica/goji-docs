...
- [ ] **Module-scoped math tasks** — slice A **on main** (`#70`/`#2`). Slice B landing (`feat/math-module-tasks-slice-b`): Pi emits `math.drill`; parent rolls up minutes/accuracy on wizard chips + day detail. Plan: [`MATH_MODULE_TASKS_PLAN.md`](./MATH_MODULE_TASKS_PLAN.md)
