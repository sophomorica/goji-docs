...
- [ ] **Writing curriculum — composition strand** (owner: important) — modes per band (narrative/informative/opinion→argument) + prompt banks tied to anchor books (read Black Beauty → write about it); manual path via journal now, Grok path per the writing-loop spec. Grammar strand shipped 2026-08-07; composition is the open half (`curriculum/subjects/writing/OBJECTIVES.md` stubs)
