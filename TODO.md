...
- [ ] **Module-scoped math tasks** — slice A landing (`feat/math-module-tasks-slice-a`): parent wizard can assign "30 problems of Times Tables at 90%"; Pi verifies by module; kiosk deep-links / filters the menu. Slice B still open: `math.drill` events + wizard chip numbers. Plan: [`MATH_MODULE_TASKS_PLAN.md`](./MATH_MODULE_TASKS_PLAN.md)
