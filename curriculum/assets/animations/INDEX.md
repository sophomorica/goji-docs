...
| Animation ID | Title | Objectives | Lesson(s) | Brief | Asset path | Status |
|--------------|-------|------------|-----------|-------|------------|--------|
...
| `anim.math.68.integers.01` | Integers on the line — left of zero, and how far | `obj.math.68.integers.01`, `obj.math.68.integers.02` (re-teach) | `lesson.math.68.integers.01`, `lesson.math.68.integers.02` | [brief](./anim.math.68.integers.01.md) | — | `brief` |
| `anim.math.68.ratios.01` | Ratios — same relationship, many pairs | `obj.math.68.ratios.01`, `obj.math.68.ratios.02` (unit-rate row) | `lesson.math.68.ratios.01`, `lesson.math.68.ratios.02` | [brief](./anim.math.68.ratios.01.md) | — | `brief` |
| `anim.math.68.equations.01` | One-step equations — undo what was done | `obj.math.68.equations.01` | `lesson.math.68.equations.01` | [brief](./anim.math.68.equations.01.md) | — | `brief` |
...
| `shipped` | On device / catalog |
| `blocked` | Waiting on player tool or objective lock |

## Add a row

1. Follow [`../../ANIMATIONS.md`](../../ANIMATIONS.md)  
2. Use brief template [`../templates/animation-brief.md`](../templates/animation-brief.md)  
3. Never leave Asset path empty if status is `ready` or `shipped` (may be absolute local path)  
