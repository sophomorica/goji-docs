# K.MG.2 parent-audit sit-through

**Charlie / Patrick / Danielle — open this file in a desktop browser:**

[`index.html`](./index.html)

Serve the `curriculum/` folder so the School HTML and pack load:
...
Then open **http://localhost:8765/learner-mvp/**

That one page is the sit-through. Do not look for a second audit page.
